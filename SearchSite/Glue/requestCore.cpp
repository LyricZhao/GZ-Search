...
void requestCore:: init() {
    globalDB = new mBerkeleyDB("/Users/stdafx/desktop/Assignment/GZ Searcher/CoreHandler/context.db");
    wordDict = new dbDUP("/Users/stdafx/desktop/Assignment/GZ Searcher/CoreHandler/worddict.db");
    token = new CJKTokenizer("/Users/stdafx/desktop/Assignment/GZ Searcher/wSplit/Word_library/word2.txt", "/Users/stdafx/desktop/Assignment/GZ Searcher/wSplit/Word_library/invalidWord.txt");
    return;
}
